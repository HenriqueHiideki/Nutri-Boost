document.addEventListener('DOMContentLoaded', () => {
  ...
  // Realce simples do item de navegação ativo conforme a seção visível
  const navItems = document.querySelectorAll('.config-nav-item');
  const secoes = ['perfil', 'notificacoes', 'seguranca', 'clinica'].map(id => document.getElementById(id));
